...
| 🐾 **Minha Titi** 🐶 | 🧟 **Jogos de Zumbi** | 📚 **Leitura** |
|:---:|:---:|:---:|
| Minha maior paixão — ela torna tudo mais leve, até os bugs mais difíceis | Sobreviver a hordas de zumbis é treino pra lidar com deadlines também | Livros de melhoria pessoal e técnicos — sempre aprendendo fora do código |
| `Amor incondicional` | `Horror` `Survival` | `Self-dev` `Técnico` |

| 🏠 **Design 3D** | 🔆 **Gravação a laser** | 🍞 **Panificação** |
|:---:|:---:|:---:|
| Plantas baixas modernas com foco em espaços funcionais | Personalizando objetos com LightBurn — tech encontra o artesanato | Fermentação natural — paciência e lógica dentro da cozinha |
| `3D` `Renderização` | `LightBurn` `DIY` | `Sourdough` `Arte` |
...
- 🇧🇷 **Português** — Nativo
- 🇺🇸 **Inglês** — Nível Pré-Avançado *(em constante evolução!)*
